  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      <div className="md:col-span-2 flex flex-col space-y-4">
        <h2 className="text-xl font-bold text-purple-900 dark:text-purple-300">Staff Internal Notes</h2>
        <p className="text-sm text-muted-foreground">These notes are completely hidden from the investor.</p>
      ...
      <div className="flex flex-col">
        <div className="bg-muted/30 p-4 rounded-lg border sticky top-4">
          ...
          <Textarea 
            ...
            placeholder="Record internal findings, risk assessments..." 
